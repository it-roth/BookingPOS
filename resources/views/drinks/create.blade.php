...
@section('title', 'Add New Drink - Cinema Management')

@section('page-title', 'Add New Drink')
            ...
            <div class="card-body">
                <form action="{{ route('drinks.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror" id="category" name="category" required>
                                    ...
                                    <option value="Hot Beverages" {{ old('category') == 'Hot Beverages' ? 'selected' : '' }}>Hot Beverages</option>
                                    <option value="Water" {{ old('category') == 'Water' ? 'selected' : '' }}>Water</option>
                                    <option value="Alcoholic" {{ old('category') == 'Alcoholic' ? 'selected' : '' }}>Alcoholic Beverages</option>
                                </select>
                                @error('category')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('size') is-invalid @enderror" id="size" name="size" required>
                                    ...
                                    <option value="regular" {{ old('size') == 'regular' ? 'selected' : '' }}>Regular</option>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Upload drink image (JPG, PNG) - Max 2MB</div>
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h4 id="name-preview">New Drink</h4>
                <div class="mb-2">
                    <span id="category-preview" class="badge bg-primary me-1">Category</span>
                    <span id="size-preview" class="badge bg-secondary">Regular</span>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        nameInput.addEventListener('input', function() {
            namePreview.textContent = this.value || 'New Drink';
        });
        ...
        imageInput.addEventListener('change', function() {
            if (this.files && this.files[0]) {
                ...
                imagePreview.innerHTML = '<i class="fas fa-coffee fa-4x text-secondary"></i>';
            }
        });
